...
def create_board(board):
    board[0][0] = Piece('y', 'r', 'images/y_rook.png',False)
    board[1][0] = Piece('y', 'b', 'images/y_bishop.png',False)
    board[2][0] = Piece('y', 'q', 'images/y_king.png',False)
    board[3][0] = Piece('y', 'k', 'images/y_queen.png',False)
    board[4][0] = Piece('y', 'b', 'images/y_bishop.png',False)
    board[5][0] = Piece('y', 'r', 'images/y_rook.png',False)

    board[0][1] = Piece('y', 'p', 'images/y_pawn.png',False)
    board[1][1] = Piece('y', 'p', 'images/y_pawn.png',False)
    board[2][1] = Piece('y', 'p', 'images/y_pawn.png',False)
    board[3][1] = Piece('y', 'p', 'images/y_pawn.png',True)
    board[4][1] = Piece('y', 'kn', 'images/y_knight.png',False)
    board[5][1] = Piece('y', 'kn', 'images/y_knight.png',False)

    board[0][21] = Piece('g', 'p', 'images/g_pawn.png',False)
    board[1][21] = Piece('g', 'p', 'images/g_pawn.png',False)
    board[2][21] = Piece('g', 'p', 'images/g_pawn.png',False)
    board[3][21] = Piece('g', 'p', 'images/g_pawn.png',True)
    board[4][21] = Piece('g', 'kn', 'images/g_knight.png',False)
    board[5][21] = Piece('g', 'kn', 'images/g_knight.png',False)

    board[0][22] = Piece('g', 'r', 'images/g_rook.png',False)
    board[1][22] = Piece('g', 'b', 'images/g_bishop.png',False)
    board[2][22] = Piece('g', 'q', 'images/g_queen.png',False)
    board[3][22] = Piece('g', 'k', 'images/g_king.png',False)
    board[4][22] = Piece('g', 'b', 'images/g_bishop.png',False)
    board[5][22] = Piece('g', 'r', 'images/g_rook.png',False)

    board[14][7] = Piece('w', 'kn', 'images/w_knight.png',False)
    board[14][8] = Piece('w', 'kn', 'images/w_knight.png',False)
    board[14][9] = Piece('w', 'p', 'images/w_pawnDynamite.png',True)
    board[14][10] = Piece('w', 'p', 'images/w_pawn.png',False)
    board[14][11] = Piece('w', 'p', 'images/w_pawn.png',False)
    board[14][12] = Piece('w', 'p', 'images/w_pawn.png',False)
    board[14][4] = Piece('b', 'kn', 'images/b_knight.png',False)
    board[14][5] = Piece('b', 'kn', 'images/b_knight.png',False)

    board[15][7] = Piece('w', 'r', 'images/w_rook.png',False)
    board[15][8] = Piece('w', 'b', 'images/w_bishop.png',False)
    board[15][9] = Piece('w', 'k', 'images/w_king.png',False)
    board[15][10] = Piece('w', 'q', 'images/w_queen.png',False)
    board[15][11] = Piece('w', 'b', 'images/w_bishop.png',False)
    board[15][12] = Piece('w', 'r', 'images/w_rook.png',False)

    board[14][4] = Piece('b', 'kn', 'images/b_knight.png',False)
    board[14][5] = Piece('b', 'kn', 'images/b_knight.png',False)


    board[14][0] = Piece('b', 'p', 'images/b_pawn.png',False)
    board[14][1] = Piece('b', 'p', 'images/b_pawn.png',False)
    board[14][2] = Piece('b', 'p', 'images/b_pawn.png',False)
    board[14][3] = Piece('b', 'p', 'images/b_pawnDynamite.png',True)


    board[15][4] = Piece('b', 'b', 'images/b_bishop.png',False)
    board[15][5] = Piece('b', 'r', 'images/b_rook.png',False)
    board[15][0] = Piece('b', 'r', 'images/b_rook.png',False)
    board[15][1] = Piece('b', 'b', 'images/b_bishop.png',False)
    board[15][2] = Piece('b', 'q', 'images/b_queen.png',False)
    board[15][3] = Piece('b', 'k', 'images/b_king.png',False)




    board[13][14] = Piece('r', 'p', 'images/r_pawnDynamite.png',True)
    board[13][15] = Piece('r', 'p', 'images/r_pawn.png',False)
    board[13][16] = Piece('r', 'p', 'images/r_pawn.png',False)
    board[13][17] = Piece('r', 'p', 'images/r_pawn.png',False)


    board[14][14] = Piece('r', 'r', 'images/r_rook.png',False)
    board[14][15] = Piece('r', 'kn', 'images/r_knight.png',False)
    board[14][16] = Piece('r', 'kn', 'images/r_knight.png',False)
    board[14][17] = Piece('r', 'r', 'images/r_rook.png',False)
    board[15][14] = Piece('r', 'b', 'images/r_bishop.png',False)
    board[15][15] = Piece('r', 'k', 'images/r_king.png',False)
    board[15][16] = Piece('r', 'q', 'images/r_queen.png',False)
    board[15][17] = Piece('r', 'b', 'images/r_bishop.png',False)

    board[13][20] = Piece('u', 'p', 'images/u_pawn.png',False)
    board[13][19] = Piece('u', 'p', 'images/u_pawn.png',True)
    board[13][21] = Piece('u', 'p', 'images/u_pawn.png',False)
    board[13][22] = Piece('u', 'p', 'images/u_pawn.png',False)


    board[14][19] = Piece('u', 'r', 'images/u_rook.png',False)
    board[14][20] = Piece('u', 'kn', 'images/u_knight.png',False)
    board[14][21] = Piece('u', 'kn', 'images/u_knight.png',False)
    board[14][22] = Piece('u', 'r', 'images/u_rook.png',False)
    board[15][19] = Piece('u', 'b', 'images/u_bishop.png',False)
    board[15][20] = Piece('u', 'k', 'images/u_king.png',False)
    board[15][21] = Piece('u', 'q', 'images/u_queen.png',False)
    board[15][22] = Piece('u', 'b', 'images/u_bishop.png',False)
    return board
